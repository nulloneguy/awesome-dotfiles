...
local awesome_overrides = function(theme)
   ...
   theme.titlebar_bg_focus = gtk_variable().bg_color:sub(1, 7) .. "99"
   theme.titlebar_bg_normal = gtk_variable().base_color:sub(1, 7) .. "88"
   ...
   -- Menu
   theme.menu_font = "Clear Sans Regular 10"
   theme.menu_submenu = "" -- ➤

   theme.menu_height = dpi(20)
   theme.menu_width = dpi(200)
   theme.menu_border_width = dpi(16)
   ...
   -- Tasklist
   theme.tasklist_font = "Clear Sans Regular 10"
   ...
   -- Hotkey popup
   theme.hotkeys_font = "Clear Sans Bold"
   theme.hotkeys_description_font = "Clear Sans Regular"
